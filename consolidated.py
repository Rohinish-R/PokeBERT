...
# ========================================================================================================================
# Certain configurations are required to make sure the program can assist you well, please make sure these files are in
# the the same directory and change the names as appropriate

IMAGE_LOCATION = "test_images" 
PROMPT_FILE_NAME = "test_prompts_orders.json"
ELECTRA_LOC = "./electra"

# IMPORTANT: Please download the JSON data for prompts and add 'DATA =' at the start of the file, save it as .py instead
# of .json and run the program
# ========================================================================================================================
